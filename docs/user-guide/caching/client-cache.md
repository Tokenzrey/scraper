...
async def get_user(
    request: Request, response: Response, user_id: int, db: Annotated[AsyncSession, Depends(async_get_db)]
):
...
async def get_post(
    request: Request, response: Response, post_id: int, db: Annotated[AsyncSession, Depends(async_get_db)]
):
